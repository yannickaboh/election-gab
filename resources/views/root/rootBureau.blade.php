        ...
        <div class="grid grid-cols-12 gap-12 mt-5">
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                ...
                <div id="large-modal-size-preview" class="modal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <form method="POST" action="{{ route('rootAddBureau') }}">
                                @csrf
                                <!-- BEGIN: Modal Header -->
                                ...
                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                    ...
                                    <div class="col-span-12 sm:col-span-6">
                                        <label for="modal-form-1" class="form-label">Type de bureau</label>
                                        <input type="text" class="form-control" readonly name="type_bureau" value="Vote">
                                    </div>
                ...
                <div class="hidden md:block mx-auto text-slate-500">
                    Affiche de 1 a 10 sur {{ $bureaux->count() }} bureaux de vote
                </div>

                <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                    <div class="w-56 relative text-slate-500">
                        <form id="search-ville" action="{{ route('rootSearchBureau') }}" method="GET" class="d-none">
                            @csrf
                    ...
                    <table class="table table-report -mt-2">
                        ...
                        <tbody>
                                ...
                                @foreach ($bureaux as $bureau)
                                    <tr class="intro-x">
                                        <td class="w-40">
                                            {{ $bureau->centre_id ? $bureau->centre->code : 'Non defini' }}
                                        </td>
                                        <td class="text-center">
                                            {{ $bureau->responsable_id ? $bureau->responsable->name : 'Non defini' }}
                                        </td>
                                        <td class="text-center">
                                            {{ $bureau->code }}
                                        </td>
                                        ...
                                        <td class="table-report__action w-56">
                                            <div class="flex justify-center items-center">
                                                <a class="flex items-center mr-3" href="javascript:;" data-tw-toggle="modal"
                                                    data-tw-target="#update-{{ $bureau->id }}"> <i data-lucide="edit"
                                                        class="w-4 h-4 mr-1"></i> </a>
                                                        <a class="flex items-center mr-3" href="javascript:;" data-tw-toggle="modal"
                                                            data-tw-target="#affect-{{ $bureau->id }}"> <i data-lucide="user"
                                                                class="w-4 h-4 mr-1"></i> </a>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <div id="update-{{ $bureau->id }}" class="modal" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <form method="POST" action="{{ route('rootEditBureau') }}">
                                                    @csrf
                                                    <!-- BEGIN: Modal Header -->
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                                        ...
                                                        <div class="col-span-12 sm:col-span-6">
                                                            ...
                                                            <select id="modal-form-6" class="form-select" name="centre_id">
                                                                @foreach ($centres as $centre)
                                                                    @if ($centre->id == $bureau->centre_id)
                                                                        <option value="{{ $centre->id }}" selected>
                                                                            {{ $centre->libelle }}</option>
                                                                    @else
                                                        ...
                                                        <div class="col-span-12 sm:col-span-6">
                                                            <input type="hidden" name="bureau_id"
                                                                value="{{ $bureau->id }}">
                                                            <label for="modal-form-1" class="form-label">Code</label>
                                                            <input type="text" class="form-control" placeholder="GA"
                                                                name="code" value="{{ $bureau->code }}">
                                                        </div>

                                                        <div class="col-span-12 sm:col-span-6">
                                                            <label for="modal-form-2" class="form-label">Libelle</label>
                                                            <input type="text" class="form-control" placeholder="GABON"
                                                                name="libelle" value="{{ $bureau->libelle }}">
                                                        </div>

                                                        <div class="col-span-12 sm:col-span-6">
                                                            <label for="modal-form-2" class="form-label">Telephone</label>
                                                            <input type="text" class="form-control" placeholder="(+241) 74 83 56 31" 
                                                            name="phone" value="{{ $bureau->phone }}">
                                                        </div>
                    
                                                        <div class="col-span-12 sm:col-span-6">
                                                            <label for="modal-form-2" class="form-label">Adresse</label>
                                                            <input type="text" class="form-control" 
                                                            placeholder="Quartier IAI, Au sein de l'institut" name="adresse" value="{{ $bureau->adresse }}">
                                                        </div>
                                    ...
                                    <!-- BEGIN: Delete Confirmation Modal -->
                                    <div id="affect-{{ $bureau->id }}" class="modal" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <form method="POST" action="{{ route('rootAffectBureau') }}">
                                                    @csrf
                                                    <!-- BEGIN: Modal Header -->
                                                    <div class="modal-header">
                                                        ...
                                                        <div class="col-span-12 sm:col-span-12">
                                                            ...
                                                            <select id="modal-form-6" class="form-select" name="responsable_id">
                                                                @foreach ($users as $user)
                                                                    @if ($user->id == $bureau->responsable_id)
