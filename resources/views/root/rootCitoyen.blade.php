...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        ...
        <div id="new-user" class="modal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form method="POST" action="{{ route('rootAddCitoyen') }}">
                        @csrf
                        <!-- BEGIN: Modal Header -->
                        <div class="modal-header">
                            <h2 class="font-medium text-base mr-auto">Nouvel Electeur
                            </h2>
                        ...
                        <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                            ...
                            <div class="col-span-12 sm:col-span-6">
                                ...
                                <input type="text" readonly class="form-control"
                                    name="password" value="Electeur@cge">
                            </div>
                            <div class="col-span-12 sm:col-span-6">
        ...
        <div class="hidden md:block mx-auto text-slate-500">Liste des Electeurs</div>

        <form method="GET" action="{{ route('rootSearchCitoyen') }}">
            @csrf
    ...
    @if ($candidatures)
        ...
        @foreach ($candidatures as $candidat)
                    ...
                    <div class="flex flex-wrap lg:flex-nowrap items-center justify-center p-5">
                        <div class="w-full lg:w-1/2 mb-4 lg:mb-0 mr-auto">
                            <div class="flex text-slate-500 text-xs">
                                <div class="mr-auto">Electeur valide ?</div>
                            </div>
            ...
            <div id="update-{{ $candidat->citoyen->id }}" class="modal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <form method="POST" action="{{ route('rootEditCitoyen') }}">
                            @csrf
                            <!-- BEGIN: Modal Header -->
                            <div class="modal-header">
            ...
            <div id="avatar-{{ $candidat->citoyen->id }}" class="modal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <form method="POST" action="{{ route('rootPhotoCitoyen') }}"
    ...
    @else
        ...
        <div class="col-span-12 mt-6 -mb-6 intro-y">
            <div class="alert alert-dismissible show box bg-primary text-white flex items-center mb-6" role="alert">
                <span>Aucun electeur pour le moment !</span>
